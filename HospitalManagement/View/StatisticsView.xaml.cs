...
namespace HospitalManagement.View
{
    public sealed partial class StatisticsWindow : Window
    {
        ...
        public StatisticsWindow(HospitalDbContext dbContext = null)
        {
            ...
            _dbContext = dbContext ?? new HospitalDbContext();
        ...
        private void ConfigureWindow()
        {
            ...
            this.Closed += StatisticsWindow_Closed;
        }
        ...
        private void LoadPatientDistribution()
        {
            try
            {
                ...
                foreach (var kvp in data.Where(kvp => kvp.Value >= 0))
                {
        ...
        private void LoadDemographics()
        {
            try
            {
                ...
                foreach (var entry in genderData.Where(kvp => kvp.Value >= 0))
                {
